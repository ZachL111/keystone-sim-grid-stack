"""Regression checks for the keystone-sim-grid-stack casebook."""
...
from casebook.harness import assert_expected, keystone_sim_grid_stack_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(keystone_sim_grid_stack_summary(), assert_expected())
